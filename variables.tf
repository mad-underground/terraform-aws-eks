variable "eks" {
  ...
  type = object({
    ...
    cluster_encryption_config = optional(list(any), [])
    ...
    node_security_group_ntp_ipv4_cidr_block = optional(list(string), ["0.0.0.0/0"])
    ...
    node_security_group_ntp_ipv6_cidr_block = optional(list(string), ["::/0"])
